...
### `ye-shaiyoe` · solo programmer · 17 y/o

PKL @ **Balai Metrologi Legal** — membangun sistem manajemen surat pemerintah
...
| High-level | Go · Python · PHP · JS (Node, Vue) |
| Platform | Arch Linux (Hyprland) · Windows 11 |
| Mindset | Security-aware · Performance-driven |
